...
local AimbotFOV = AimbotPage:Section({Name = "FOV Settings", Side = "Right"})

AimbotMain:Toggle({Name = "Enable Aimbot", Flag = "Aimbot_Enabled"})
AimbotMain:Toggle({Name = "Silent Aim", Flag = "Aimbot_Silent"})
AimbotMain:Keybind({Name = "Activation Key", Flag = "Aimbot_Key", Default = Enum.KeyCode.RightShift, Mode = "Hold"})
AimbotMain:List({Name = "Target Selection", Flag = "Aimbot_Selection", Options = {"Closest to Crosshair", "Closest to Player", "Lowest Health", "Highest Threat"}, Default = "Closest to Crosshair"})
AimbotMain:List({Name = "Hitpart", Flag = "Aimbot_Hitpart", Options = {"Head", "HumanoidRootPart", "Torso", "Random", "Nearest"}, Default = "Head"})
AimbotMain:Slider({Name = "Max Distance", Flag = "Aimbot_MaxDist", Min = 50, Max = 5000, Default = 1000, Decimals = 0})
AimbotMain:Toggle({Name = "Auto Shoot", Flag = "Aimbot_AutoShoot"})
AimbotMain:Toggle({Name = "Auto Wallbang", Flag = "Aimbot_AutoWall"})
AimbotMain:Slider({Name = "Hitchance %", Flag = "Aimbot_Hitchance", Min = 0, Max = 100, Default = 80, Decimals = 0})
...
AimbotAdvanced:Slider({Name = "Prediction Strength", Flag = "Aimbot_PredStrength", Min = 0, Max = 10, Default = 1, Decimals = 2})
AimbotAdvanced:Toggle({Name = "Resolver", Flag = "Aimbot_Resolver"})
AimbotAdvanced:List({Name = "Resolver Method", Flag = "Aimbot_ResolverMethod", Options = {"Default", "Delta", "Brute Force", "Animation"}, Default = "Default"})
AimbotAdvanced:Toggle({Name = "Ignore Friends", Flag = "Aimbot_IgnoreFriends", Default = true})
AimbotAdvanced:Toggle({Name = "Ignore NPCs", Flag = "Aimbot_IgnoreNPCs", Default = true})
AimbotAdvanced:Toggle({Name = "Require Mouse Down", Flag = "Aimbot_RequireMouse"})
AimbotAdvanced:Keybind({Name = "Override Key", Flag = "Aimbot_OverrideKey", Default = Enum.KeyCode.LeftControl})

AimbotFOV:Toggle({Name = "Show FOV Circle", Flag = "Aimbot_ShowFOV", Default = true})
AimbotFOV:Colorpicker({Name = "FOV Color", Flag = "Aimbot_FOVColor", Default = Color3.fromRGB(255, 88, 166)})
AimbotFOV:Toggle({Name = "FOV Filled", Flag = "Aimbot_FOVFilled"})
AimbotFOV:Slider({Name = "FOV Thickness", Flag = "Aimbot_FOVThickness", Min = 1, Max = 5, Default = 2, Decimals = 0})
AimbotFOV:Toggle({Name = "Dynamic FOV", Flag = "Aimbot_DynamicFOV"})
AimbotFOV:Slider({Name = "Min FOV", Flag = "Aimbot_MinFOV", Min = 0, Max = 500, Default = 50, Decimals = 0})
...
ESPVisuals:Toggle({Name = "Show Sleeping", Flag = "ESP_ShowSleeping"})
ESPVisuals:Toggle({Name = "Show Bot", Flag = "ESP_ShowBot"})
ESPVisuals:Slider({Name = "Text Size", Flag = "ESP_TextSize", Min = 8, Max = 24, Default = 13, Decimals = 0})
ESPVisuals:Slider({Name = "Box Thickness", Flag = "ESP_BoxThickness", Min = 1, Max = 5, Default = 2, Decimals = 0})
ESPVisuals:Slider({Name = "Tracer Thickness", Flag = "ESP_TracerThickness", Min = 1, Max = 5, Default = 2, Decimals = 0})
...
ESPVisuals:Colorpicker({Name = "Tracer Color", Flag = "ESP_TracerColor", Default = Color3.fromRGB(255, 255, 255)})
ESPVisuals:Colorpicker({Name = "Skeleton Color", Flag = "ESP_SkeletonColor", Default = Color3.fromRGB(255, 255, 255)})
ESPVisuals:Colorpicker({Name = "Box Outline", Flag = "ESP_BoxOutline", Default = Color3.fromRGB(0, 0, 0)})

local ESPCustom = ESPPage:Section({Name = "Custom", Side = "Right"})
ESPCustom:Toggle({Name = "Weapon ESP", Flag = "ESP_Weapon"})
ESPCustom:Toggle({Name = "Ammo Display", Flag = "ESP_Ammo"})
ESPCustom:Toggle({Name = "Health Text", Flag = "ESP_HealthText"})
ESPCustom:Toggle({Name = "Flags", Flag = "ESP_Flags"})
ESPCustom:List({Name = "Font", Flag = "ESP_Font", Options = {"RobotoMono", "SourceSans", "Gotham", "Arial"}, Default = "RobotoMono"})
ESPCustom:Toggle({Name = "Outline Text", Flag = "ESP_OutlineText", Default = true})
ESPCustom:Slider({Name = "Fade Distance", Flag = "ESP_FadeDist", Min = 100, Max = 5000, Default = 2000, Decimals = 0})
ESPCustom:Toggle({Name = "Rainbow Mode", Flag = "ESP_Rainbow"})
...
local ChamsAdvanced = ChamsPage:Section({Name = "Advanced", Side = "Right"})
...
ChamsMain:List({Name = "Material", Flag = "Chams_Material", Options = {"ForceField", "Neon", "Glass", "Plastic", "SmoothPlastic", "Foil"}, Default = "ForceField"})
...
ChamsSettings:Colorpicker({Name = "Enemy Visible", Flag = "Chams_EnemyVisColor", Default = Color3.fromRGB(255, 100, 100)})
ChamsSettings:Colorpicker({Name = "Team Visible", Flag = "Chams_TeamVisColor", Default = Color3.fromRGB(100, 255, 100)})

ChamsAdvanced:Toggle({Name = "Wireframe", Flag = "Chams_Wireframe"})
ChamsAdvanced:Toggle({Name = "Through Walls", Flag = "Chams_ThroughWalls"})
ChamsAdvanced:Slider({Name = "Fill Transparency", Flag = "Chams_FillTrans", Min = 0, Max = 1, Default = 0.5, Decimals = 2})
ChamsAdvanced:Slider({Name = "Outline Transparency", Flag = "Chams_OutlineTrans", Min = 0, Max = 1, Default = 0, Decimals = 2})
ChamsAdvanced:Toggle({Name = "Rainbow Chams", Flag = "Chams_Rainbow"})
ChamsAdvanced:Slider({Name = "Rainbow Speed", Flag = "Chams_RainbowSpeed", Min = 1, Max = 20, Default = 5, Decimals = 0})
ChamsAdvanced:List({Name = "Chams Type", Flag = "Chams_Type", Options = {"All", "Visible Only", "Behind Walls", "Custom"}, Default = "All"})
...
VisualsLighting:Slider({Name = "Ambient", Flag = "Visuals_Ambient", Min = 0, Max = 1, Default = 0.5, Decimals = 2})
VisualsLighting:Slider({Name = "Outdoor Ambient", Flag = "Visuals_OutdoorAmbient", Min = 0, Max = 1, Default = 0.5, Decimals = 2})
VisualsLighting:Colorpicker({Name = "Fog Color", Flag = "Visuals_FogColor", Default = Color3.fromRGB(192, 192, 192)})
VisualsLighting:Slider({Name = "Fog Start", Flag = "Visuals_FogStart", Min = 0, Max = 1000, Default = 0, Decimals = 0})
VisualsLighting:Slider({Name = "Fog End", Flag = "Visuals_FogEnd", Min = 100, Max = 10000, Default = 10000, Decimals = 0})
VisualsLighting:Toggle({Name = "Clock Time Lock", Flag = "Visuals_ClockLock"})
VisualsLighting:Slider({Name = "Clock Time", Flag = "Visuals_ClockTime", Min = 0, Max = 24, Default = 12, Decimals = 1})
VisualsLighting:Toggle({Name = "Geographic Latitude", Flag = "Visuals_GeoLat"})
VisualsLighting:Slider({Name = "Latitude", Flag = "Visuals_Latitude", Min = -90, Max = 90, Default = 41.73, Decimals = 2})
...
VisualsEffects:Colorpicker({Name = "NV Color", Flag = "Visuals_NVColor", Default = Color3.fromRGB(0, 255, 0)})
VisualsEffects:Slider({Name = "NV Brightness", Flag = "Visuals_NVBrightness", Min = 0, Max = 5, Default = 1, Decimals = 1})
VisualsEffects:Toggle({Name = "Crosshair", Flag = "Visuals_Crosshair"})
VisualsEffects:List({Name = "Crosshair Type", Flag = "Visuals_CrosshairType", Options = {"Dot", "Cross", "Circle", "Dynamic", "TS"}, Default = "Cross"})
VisualsEffects:Colorpicker({Name = "Crosshair Color", Flag = "Visuals_CrosshairColor", Default = Color3.fromRGB(255, 88, 166)})
VisualsEffects:Slider({Name = "Crosshair Size", Flag = "Visuals_CrosshairSize", Min = 2, Max = 50, Default = 10, Decimals = 0})
VisualsEffects:Slider({Name = "Crosshair Gap", Flag = "Visuals_CrosshairGap", Min = 0, Max = 20, Default = 4, Decimals = 0})
VisualsEffects:Slider({Name = "Crosshair Thickness", Flag = "Visuals_CrosshairThick", Min = 1, Max = 5, Default = 2, Decimals = 0})
...
VisualsEffects:Toggle({Name = "Remove Textures", Flag = "Visuals_NoTextures"})
VisualsEffects:Toggle({Name = "Wireframe Map", Flag = "Visuals_Wireframe"})
VisualsEffects:Colorpicker({Name = "World Color", Flag = "Visuals_WorldColor", Default = Color3.fromRGB(255, 255, 255)})
VisualsEffects:Toggle({Name = "Hit Chams", Flag = "Visuals_HitChams"})
VisualsEffects:Colorpicker({Name = "Hit Chams Color", Flag = "Visuals_HitChamsColor", Default = Color3.fromRGB(255, 255, 0)})
VisualsEffects:Slider({Name = "Hit Chams Duration", Flag = "Visuals_HitChamsDur", Min = 0.1, Max = 5, Default = 1, Decimals = 1})
VisualsEffects:Toggle({Name = "Bullet Tracers", Flag = "Visuals_BulletTracers"})
VisualsEffects:Colorpicker({Name = "Tracer Color", Flag = "Visuals_TracerColor", Default = Color3.fromRGB(255, 255, 255)})
VisualsEffects:Slider({Name = "Tracer Lifetime", Flag = "Visuals_TracerLife", Min = 0.1, Max = 5, Default = 1, Decimals = 1})
VisualsEffects:Toggle({Name = "Impact Effects", Flag = "Visuals_Impacts"})
VisualsEffects:Colorpicker({Name = "Impact Color", Flag = "Visuals_ImpactColor", Default = Color3.fromRGB(255, 0, 0)})

local VisualsCamera = VisualsPage:Section({Name = "Camera", Side = "Right"})
VisualsCamera:Toggle({Name = "Third Person", Flag = "Visuals_ThirdPerson"})
VisualsCamera:Keybind({Name = "Third Person Key", Flag = "Visuals_ThirdPersonKey", Default = Enum.KeyCode.V})
VisualsCamera:Slider({Name = "Distance", Flag = "Visuals_ThirdPersonDist", Min = 5, Max = 50, Default = 15, Decimals = 1})
VisualsCamera:Toggle({Name = "Collision", Flag = "Visuals_ThirdPersonColl", Default = true})
VisualsCamera:Slider({Name = "FOV", Flag = "Visuals_CameraFOV", Min = 30, Max = 120, Default = 70, Decimals = 0})
VisualsCamera:Toggle({Name = "No Recoil", Flag = "Visuals_NoRecoil"})
VisualsCamera:Toggle({Name = "No Spread", Flag = "Visuals_NoSpread"})
VisualsCamera:Toggle({Name = "No Sway", Flag = "Visuals_NoSway"})
VisualsCamera:Slider({Name = "Viewmodel X", Flag = "Visuals_VMX", Min = -5, Max = 5, Default = 0, Decimals = 1})
VisualsCamera:Slider({Name = "Viewmodel Y", Flag = "Visuals_VMY", Min = -5, Max = 5, Default = 0, Decimals = 1})
VisualsCamera:Slider({Name = "Viewmodel Z", Flag = "Visuals_VMZ", Min = -5, Max = 5, Default = 0, Decimals = 1})
VisualsCamera:Toggle({Name = "Viewmodel Chams", Flag = "Visuals_VMChams"})
VisualsCamera:Colorpicker({Name = "VM Color", Flag = "Visuals_VMColor", Default = Color3.fromRGB(255, 88, 166)})
...
local MovementExploits = MovementPage:Section({Name = "Exploits", Side = "Right"})
...
MovementBasic:Toggle({Name = "Auto Sprint", Flag = "Movement_AutoSprint"})
MovementBasic:Slider({Name = "Sprint Speed", Flag = "Movement_SprintSpeed", Min = 0, Max = 200, Default = 70, Decimals = 1})
MovementBasic:Toggle({Name = "Crouch Speed", Flag = "Movement_CrouchSpeed"})
MovementBasic:Slider({Name = "Crouch Amount", Flag = "Movement_CrouchAmount", Min = 0, Max = 100, Default = 15, Decimals = 1})
MovementBasic:Toggle({Name = "No Fall Damage", Flag = "Movement_NoFallDamage"})
MovementBasic:Toggle({Name = "Edge Jump", Flag = "Movement_EdgeJump"})

MovementAdvanced:Toggle({Name = "Noclip", Flag = "Movement_Noclip"})
MovementAdvanced:Keybind({Name = "Noclip Key", Flag = "Movement_NoclipKey", Default = Enum.KeyCode.N})
MovementAdvanced:Toggle({Name = "Fly", Flag = "Movement_Fly"})
MovementAdvanced:Keybind({Name = "Fly Key", Flag = "Movement_FlyKey", Default = Enum.KeyCode.F})
MovementAdvanced:Slider({Name = "Fly Speed", Flag = "Movement_FlySpeed", Min = 0, Max = 200, Default = 50, Decimals = 1})
MovementAdvanced:Toggle({Name = "Fly No Gravity", Flag = "Movement_FlyNoGrav"})
MovementAdvanced:Toggle({Name = "BHop (Strafe)", Flag = "Movement_BHop"})
MovementAdvanced:Slider({Name = "BHop Speed", Flag = "Movement_BHopSpeed", Min = 0, Max = 200, Default = 50, Decimals = 1})
MovementAdvanced:Slider({Name = "Velocity Multiplier", Flag = "Movement_VelocityMult", Min = 0, Max = 5, Default = 1, Decimals = 2})
MovementAdvanced:Toggle({Name = "Air Strafe", Flag = "Movement_AirStrafe"})
MovementAdvanced:Slider({Name = "Strafe Acceleration", Flag = "Movement_StrafeAccel", Min = 0, Max = 10, Default = 1, Decimals = 2})
MovementAdvanced:Toggle({Name = "Auto BHop", Flag = "Movement_AutoBHop"})
MovementAdvanced:Toggle({Name = "Jump Bug", Flag = "Movement_JumpBug"})
MovementAdvanced:Keybind({Name = "Jump Bug Key", Flag = "Movement_JumpBugKey", Default = Enum.KeyCode.LeftShift})
MovementAdvanced:Toggle({Name = "Long Jump", Flag = "Movement_LongJump"})
MovementAdvanced:Keybind({Name = "Long Jump Key", Flag = "Movement_LongJumpKey", Default = Enum.KeyCode.LeftAlt})
MovementAdvanced:Slider({Name = "LJ Power", Flag = "Movement_LJPower", Min = 0, Max = 500, Default = 280, Decimals = 0})

MovementExploits:Toggle({Name = "Speed Hack", Flag = "Movement_SpeedHack"})
MovementExploits:Slider({Name = "Speed Factor", Flag = "Movement_SpeedFactor", Min = 1, Max = 100, Default = 10, Decimals = 1})
MovementExploits:Toggle({Name = "Gravity Modifier", Flag = "Movement_GravityMod"})
MovementExploits:Slider({Name = "Gravity", Flag = "Movement_Gravity", Min = 0, Max = 196.2, Default = 196.2, Decimals = 1})
MovementExploits:Toggle({Name = "Infinite Stamina", Flag = "Movement_InfStamina"})
MovementExploits:Toggle({Name = "No Clip (Exploit)", Flag = "Movement_NoClipExploit"})
MovementExploits:Toggle({Name = "TP Walk", Flag = "Movement_TPWalk"})
MovementExploits:Keybind({Name = "TP Walk Key", Flag = "Movement_TPWalkKey", Default = Enum.KeyCode.T})
MovementExploits:Slider({Name = "TP Distance", Flag = "Movement_TPDist", Min = 1, Max = 50, Default = 10, Decimals = 0})
MovementExploits:Toggle({Name = "Platform Stand", Flag = "Movement_PlatformStand"})

-- ========================================
-- =========== MISC ======================
-- ========================================

local MiscMain = MiscPage:Section({Name = "Main"})
local MiscGame = MiscPage:Section({Name = "Game", Side = "Right"})
local MiscPlayer = MiscPage:Section({Name = "Local Player", Side = "Right"})

MiscMain:Toggle({Name = "Enable Misc", Flag = "Misc_Enabled"})
MiscMain:Toggle({Name = "Auto Reload", Flag = "Misc_AutoReload"})
MiscMain:Toggle({Name = "No Spread", Flag = "Misc_NoSpread"})
MiscMain:Toggle({Name = "No Recoil", Flag = "Misc_NoRecoil"})
MiscMain:Toggle({Name = "Rapid Fire", Flag = "Misc_RapidFire"})
MiscMain:Slider({Name = "Fire Rate", Flag = "Misc_FireRate", Min = 1, Max = 1000, Default = 100, Decimals = 0})
MiscMain:Toggle({Name = "Infinite Ammo", Flag = "Misc_InfAmmo"})
MiscMain:Toggle({Name = "Instant Hit", Flag = "Misc_InstantHit"})
MiscMain:Toggle({Name = "Bullet TP", Flag = "Misc_BulletTP"})
MiscMain:Toggle({Name = "Wallbang", Flag = "Misc_Wallbang"})
MiscMain:Slider({Name = "Wallbang Damage", Flag = "Misc_WallbangDmg", Min = 0, Max = 100, Default = 100, Decimals = 0})

MiscGame:Toggle({Name = "Chat Spammer", Flag = "Misc_ChatSpam"})
MiscGame:Textbox({Name = "Spam Message", Flag = "Misc_SpamMsg", Placeholder = "Message here"})
MiscGame:Slider({Name = "Spam Delay", Flag = "Misc_SpamDelay", Min = 0.1, Max = 10, Default = 1, Decimals = 1})
MiscGame:Button({Name = "Start Spam", Callback = function() Library:Notification("Chat spam started!", 2) end})
MiscGame:Button({Name = "Stop Spam", Callback = function() Library:Notification("Chat spam stopped!", 2) end})
MiscGame:Toggle({Name = "Auto Vote Kick", Flag = "Misc_AutoVoteKick"})
MiscGame:Toggle({Name = "Auto Accept Trade", Flag = "Misc_AutoTrade"})
MiscGame:Toggle({Name = "Log Chats", Flag = "Misc_LogChats"})
MiscGame:Toggle({Name = "Log Joins", Flag = "Misc_LogJoins"})
MiscGame:Toggle({Name = "Log Leaves", Flag = "Misc_LogLeaves"})
MiscGame:Button({Name = "Copy Logs", Callback = function() Library:Notification("Logs copied!", 2) end})
MiscGame:Toggle({Name = "Anti Chat Log", Flag = "Misc_AntiChatLog"})
MiscGame:Toggle({Name = "Anti Report", Flag = "Misc_AntiReport"})

MiscPlayer:Toggle({Name = "God Mode", Flag = "Misc_GodMode"})
MiscPlayer:Toggle({Name = "Invisible", Flag = "Misc_Invisible"})
MiscPlayer:Toggle({Name = "No Clip", Flag = "Misc_NoClip"})
MiscPlayer:Slider({Name = "Health", Flag = "Misc_Health", Min = 0, Max = 999999, Default = 100, Decimals = 0})
MiscPlayer:Button({Name = "Set Health", Callback = function() Library:Notification("Health set!", 2) end})
MiscPlayer:Toggle({Name = "Force Reset", Flag = "Misc_ForceReset"})
MiscPlayer:Keybind({Name = "Reset Key", Flag = "Misc_ResetKey", Default = Enum.KeyCode.R})
MiscPlayer:Toggle({Name = "Anti Ragdoll", Flag = "Misc_AntiRagdoll"})
MiscPlayer:Toggle({Name = "Anti Stun", Flag = "Misc_AntiStun"})
MiscPlayer:Toggle({Name = "Walk on Water", Flag = "Misc_WalkWater"})
MiscPlayer:Toggle({Name = "Jesus Power", Flag = "Misc_JesusPower"})
MiscPlayer:Slider({Name = "Gravity", Flag = "Misc_Gravity", Min = 0, Max = 196, Default = 196, Decimals = 1})
MiscPlayer:Toggle({Name = "No Clip Camera", Flag = "Misc_NoClipCam"})
MiscPlayer:Toggle({Name = "Freecam", Flag = "Misc_Freecam"})
MiscPlayer:Keybind({Name = "Freecam Key", Flag = "Misc_FreecamKey", Default = Enum.KeyCode.P})
MiscPlayer:Slider({Name = "Freecam Speed", Flag = "Misc_FreecamSpeed", Min = 1, Max = 100, Default = 50, Decimals = 0})

local MiscExploits = MiscPage:Section({Name = "Exploits", Side = "Right"})
MiscExploits:Toggle({Name = "Dex Explorer", Flag = "Misc_DexExplorer"})
MiscExploits:Keybind({Name = "Dex Key", Flag = "Misc_DexKey", Default = Enum.KeyCode.Insert})
MiscExploits:Toggle({Name = "Remote Spy", Flag = "Misc_RemoteSpy"})
MiscExploits:Keybind({Name = "Spy Key", Flag = "Misc_SpyKey", Default = Enum.KeyCode.F9})
MiscExploits:Toggle({Name = "Script Dumper", Flag = "Misc_ScriptDumper"})
MiscExploits:Toggle({Name = "Anti Cheat Bypass", Flag = "Misc_ACBypass"})
MiscExploits:Toggle({Name = "FPS Unlocker", Flag = "Misc_FPSUnlocker"})
MiscExploits:Slider({Name = "FPS Cap", Flag = "Misc_FPSCap", Min = 60, Max = 1000, Default = 240, Decimals = 0})
MiscExploits:Button({Name = "Execute Dex", Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/infyiff/backup/main/dex.lua"))() end})
MiscExploits:Button({Name = "Execute RemoteSpy", Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/exxtremestuffs/SimpleSpySource/master/SimpleSpy.lua"))() end})
MiscExploits:Button({Name = "Execute IY", Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source"))() end})
...
SettingsMenu:Toggle({Name = "Watermark Ping", Flag = "Settings_WatermarkPing"})
SettingsMenu:Toggle({Name = "Show FPS Graph", Flag = "Settings_FPSGraph"})
SettingsMenu:Slider({Name = "Menu Scale", Flag = "Settings_MenuScale", Min = 0.5, Max = 1.5, Default = 1, Decimals = 1})
SettingsMenu:Toggle({Name = "Blur Background", Flag = "Settings_BlurBG"})
SettingsMenu:List({Name = "Theme", Flag = "Settings_Theme", Options = {"Dark", "Light", "Midnight", "Ocean", "Custom"}, Default = "Dark"})
SettingsMenu:Keybind({Name = "Panic Key", Flag = "Settings_PanicKey", Default = Enum.KeyCode.Delete})

local SettingsUI = SettingsPage:Section({Name = "UI Settings", Side = "Right"})
SettingsUI:Toggle({Name = "Animations", Flag = "Settings_Animations", Default = true})
SettingsUI:Slider({Name = "Animation Speed", Flag = "Settings_AnimSpeed", Min = 0.1, Max = 2, Default = 1, Decimals = 1})
SettingsUI:Toggle({Name = "Tooltips", Flag = "Settings_Tooltips", Default = true})
SettingsUI:Slider({Name = "Tooltip Delay", Flag = "Settings_TipDelay", Min = 0, Max = 2, Default = 0.5, Decimals = 1})
SettingsUI:Toggle({Name = "Show Values", Flag = "Settings_ShowValues", Default = true})
SettingsUI:Toggle({Name = "Compact Mode", Flag = "Settings_CompactMode"})
SettingsUI:Colorpicker({Name = "Background Color", Flag = "Settings_BGColor", Default = Color3.fromRGB(20, 20, 20)})
SettingsUI:Colorpicker({Name = "Outline Color", Flag = "Settings_OutlineColor", Default = Color3.fromRGB(50, 50, 50)})
SettingsUI:Colorpicker({Name = "Text Color", Flag = "Settings_TextColor", Default = Color3.fromRGB(255, 255, 255)})
SettingsUI:Colorpicker({Name = "Disabled Color", Flag = "Settings_DisabledColor", Default = Color3.fromRGB(145, 145, 145)})
...
SettingsConfig:Button({Name = "Delete Config", Callback = function()
	Library:Notification("Config deleted!", 2, Color3.fromRGB(255, 50, 50))
end})
SettingsConfig:List({Name = "Config List", Flag = "Settings_ConfigList", Options = {"default", "legit", "rage", "hvh"}, Default = "default"})
SettingsConfig:Toggle({Name = "Auto Save", Flag = "Settings_AutoSave"})
SettingsConfig:Toggle({Name = "Auto Load", Flag = "Settings_AutoLoad"})

local SettingsUtility = SettingsPage:Section({Name = "Utility", Side = "Right"})
SettingsUtility:Toggle({Name = "Anti AFK", Flag = "Utility_AntiAFK", Default = true})
SettingsUtility:Toggle({Name = "Anti Kick", Flag = "Utility_AntiKick"})
SettingsUtility:Toggle({Name = "Anti Crash", Flag = "Utility_AntiCrash"})
SettingsUtility:Toggle({Name = "Chat Logger", Flag = "Utility_ChatLogger"})
SettingsUtility:Toggle({Name = "Join Logger", Flag = "Utility_JoinLogger"})
SettingsUtility:Toggle({Name = "Leave Logger", Flag = "Utility_LeaveLogger"})
SettingsUtility:Button({Name = "Rejoin Server", Callback = function()
	game:GetService("TeleportService"):Teleport(game.PlaceId, game.Players.LocalPlayer)
end})
SettingsUtility:Button({Name = "Server Hop", Callback = function()
	Library:Notification("Server hopping...", 2, Library.Accent)
end})
SettingsUtility:Button({Name = "Copy Job ID", Callback = function()
	setclipboard(game.JobId)
	Library:Notification("Job ID copied!", 2, Color3.fromRGB(0, 255, 0))
end})
SettingsUtility:Button({Name = "Copy Place ID", Callback = function()
	setclipboard(tostring(game.PlaceId))
	Library:Notification("Place ID copied!", 2, Color3.fromRGB(0, 255, 0))
end})
SettingsUtility:Button({Name = "Uninject", Callback = function()
	Library:SetOpen(false)
	Library.ScreenGUI:Destroy()
end})

local SettingsFriends = SettingsPage:Section({Name = "Friends", Side = "Right"})
SettingsFriends:Textbox({Name = "Add Friend", Flag = "Settings_AddFriend", Placeholder = "PlayerName"})
SettingsFriends:Button({Name = "Add", Callback = function()
	local name = Library.Flags.Settings_AddFriend
	if name and name ~= "" then
		table.insert(Library.Friends, name)
		Library:Notification("Added " .. name .. " to friends!", 2, Color3.fromRGB(0, 255, 0))
	end
end})
SettingsFriends:Button({Name = "Remove All", Callback = function()
	table.clear(Library.Friends)
	Library:Notification("Friends list cleared!", 2, Color3.fromRGB(255, 50, 50))
end})
SettingsFriends:List({Name = "Friends List", Flag = "Settings_FriendsList", Options = {"None"}, Default = "None"})
SettingsFriends:Toggle({Name = "Friend ESP", Flag = "Settings_FriendESP", Default = true})
SettingsFriends:Colorpicker({Name = "Friend Color", Flag = "Settings_FriendColor", Default = Color3.fromRGB(0, 255, 255)})
SettingsFriends:Toggle({Name = "Friend Chams", Flag = "Settings_FriendChams"})
SettingsFriends:Toggle({Name = "Notify on Join", Flag = "Settings_FriendNotify", Default = true})
